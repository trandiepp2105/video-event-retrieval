...
def main():
    ...
    retriever = EventFormerV1DynamicTSM(
        ...
        query_transformer_layers=retr_cfg.query_transformer_layers,
        query_transformer_heads=retr_cfg.query_transformer_heads,
        query_transformer_ff_dim=retr_cfg.query_transformer_ff_dim,
        query_transformer_dropout=retr_cfg.query_transformer_dropout,
        ...
        event_stride=retr_cfg.event_stride,
        event_window_sizes=tuple(retr_cfg.event_window_sizes),
        event_stride_ratio=retr_cfg.event_stride_ratio,
        event_pooling=retr_cfg.event_pooling,
    ...
    localizer = EventAwareMomentLocalizer(
        ...
        query_transformer_layers=loc_cfg.query_transformer_layers,
        query_transformer_heads=loc_cfg.query_transformer_heads,
        query_transformer_ff_dim=loc_cfg.query_transformer_ff_dim,
        query_transformer_dropout=loc_cfg.query_transformer_dropout,
        ...
        event_stride=loc_cfg.event_stride,
        event_window_sizes=tuple(loc_cfg.event_window_sizes),
        event_stride_ratio=loc_cfg.event_stride_ratio,
        event_pooling=loc_cfg.event_pooling,
